...
\begin{itemize}
	\item asynchronous vs. synchronous streams
	\item real time
	\item arithmetic operations
	\item stream operations
	\item ?
\end{itemize}

Different temporal logics cover different of these characteristics. An overview is given in Table ???. As it can be seen, none of the logics covers all of the considered characteristics but as shown in the next section, all of them are needed. That is why none of the mentioned temporal logics could be used in the CONIRAS project and \tessla was developed to cover all of these characteristics.
