...
\tessla was developed as a specification language for multicore systems. This is a very rough classification because there are various types of such systems. Hence in this section the systems under scrutiny for which properties should be specifiable using \tessla are described more concrete.
