...
object Diagnostics {
  ...
  /**
   * General Error raised during an optimization of the generated code.
   * Especially used during the mutability analysis
   * @param m Message with details about the error.
   */
  case class OptimizationError(m: String) extends Errors.TesslaError {
